...
import { ERROR_COMMON, ERROR_MESSAGES } from "./constants/messages.js";
import { ORDER_ERROR_REASON } from "./constants/errors.js";

class InputValidator {
  static isVisitDateValidated(visitDate) {
    VisitDateValidation.validateInputEmpty(visitDate, ERROR_MESSAGES.INVALID(ERROR_COMMON.DATE));
    VisitDateValidation.validateIsNumber(visitDate, ERROR_MESSAGES.INVALID(ERROR_COMMON.DATE));
    VisitDateValidation.validateDateRange(visitDate, ERROR_MESSAGES.INVALID(ERROR_COMMON.DATE));
  }

  static isOrderedMenuValidated(orderedMenu) {
    MenuValidation.validateMenuLength(orderedMenu, ERROR_MESSAGES.INVALID(ERROR_COMMON.ORDER));
  ...
  static isMenusValidated(menus, counts) {
    MenuValidation.validateCountIsNumber(counts, ERROR_MESSAGES.INVALID(ERROR_COMMON.ORDER));
    MenuValidation.validateMenuCounts(counts, ERROR_MESSAGES.INVALID(ERROR_COMMON.ORDER));
