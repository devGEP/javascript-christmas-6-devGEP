...
// constants
import { DISCOUNT_MONEY, SPECIAL_DISCOUNT_DAY, CHIRSTMAS_EVENT_DAY, DAYS_IN_WEEK, DAY_OF_THE_WEEK } from "../constants/common.js";
...
class DiscountCalculator {
  static calculateChristmasDDay(visitDate) {
    ...
    if (visitDate >= CHIRSTMAS_EVENT_DAY.START && visitDate <= CHIRSTMAS_EVENT_DAY.END) {
